...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>
                ...
                <td>$creationDate</td>
                <td>
                    <input type='password' class='password-field' id='password-$passengerId' value='$password' readonly>
                    <button type='button' onclick='togglePassword($passengerId)'>
                        <i class='fa fa-eye' id='toggleIcon-$passengerId'></i>
                    </button>
                </td>
              </tr>";
    }
