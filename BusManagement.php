...
<head>
    ...
    <title>IntelliRide - BusManagement</title>
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Bus Data</h6>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="input-group mr-2" style="width: auto;">
                                ...
                                <input type="text" id="busSearch" class="form-control" placeholder="Search..."
                                    onkeyup="searchBus()">
                            </div>
                            <!-- Add Bus button -->
                            <button class="btn btn-primary mr-2" data-toggle="modal" data-target="#addBusModal">Add
                                Bus</button>
                            <!-- Edit Selected Bus button -->
                            <button class="btn btn-warning text-white mr-2" onclick="editSelectedBuses()">Edit
                                Selected</button>
                            <!-- Delete Selected Bus button -->
                            <button class="btn btn-danger" onclick="deleteSelectedBuses()">Delete Selected</button>
                    ...
                    <div id="busTableContainer">
                        <!-- Dynamic Bus Data Table will be loaded here -->
                    </div>

                    <script>
                        $(document).ready(function () {
                            loadBusData(); // Load bus data on page load
                        });
                        ...
                        function loadBusData() {
                            $.ajax({
                                ...
                                success: function (data) {
                                    $('#busTableContainer').html(data); // Update the container with the table
                                },
                        ...
                        function clearSearch() {
                            ...
                            searchBus(); // Optionally call searchBus to refresh the table
                        }
                        ...
                        function searchBus() {
                            ...
                            switch (document.getElementById("columnSelect").value) {
                                case 'plate':
                                    columnIndex = 2; // Bus Plate Number column
                                    break;
                                case 'serial':
                                    columnIndex = 3; // Bus Serial Number column
                                    break;
                                case 'info':
                                    columnIndex = 4; // Bus Information column
                                    break;
                                default:
                                    columnIndex = 2; // Default to Bus Plate Number
                            }
                        ...
                        function addBus() {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'CRUD/add_bus.php', // The PHP file that handles the insertion
                                data: formData,
                                success: function (response) {
                                    // Display the success message
                                    $('#message').html(response);
                                    document.getElementById('addBusForm').reset(); // Reset the form
                                    $('#addBusModal').modal('hide'); // Hide the modal
                                    loadBusData(); // Refresh the bus table after adding
