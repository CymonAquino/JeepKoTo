...
<body style="background: linear-gradient(90deg, #49dff3, #3c66d8);">
    ...
    <div class="container" style="text-align: center; width: 100%; height: 100px;">
        <div class="screen">
            <div class="screen__content">

                <img src="img/bluebusicon.png" alt="Your Logo" style="width: 80px; height: 80px;">
                ...
                <form class="login" onsubmit="loginAdmin(event)"> <!-- Added onsubmit to call loginAdmin -->
                    ...
                    <button type="submit" class="button login__submit"> <!-- Changed to type="submit" -->
