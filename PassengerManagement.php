...
<head>
    ...
    <title>IntelliRide - PassengerManagement</title>
                    ...
                    <div class="card-header py-3 d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="input-group mr-2" style="width: auto;">
                                ...
                                <input type="text" id="passengerSearch" class="form-control" placeholder="Search..."
                            ...
                            <button class="btn btn-warning text-white mr-2" onclick="editSelectedPassengers()">Edit
                                Selected</button>
                            <!-- Delete Selected Passenger button -->
                            <button class="btn btn-danger" onclick="deleteSelectedPassengers()">Delete Selected</button>
                        </div>
                    </div>

                    <!-- Passenger Data Table -->
                    <div id="passengerTableContainer">
                        <!-- Dynamic Passenger Data Table will be loaded here -->
                    </div>
                                ...
                                <form id="editPassengerForm">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="firstName"
                                            id="editPassengerFirstName" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="editPassengerLastName">Last Name</label>
                                        <input type="text" class="form-control" name="lastName"
                                            id="editPassengerLastName" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="password"
                                            id="editPassengerPassword" required>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
