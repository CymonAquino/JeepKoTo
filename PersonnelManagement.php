...
<head>
    ...
    <title>IntelliRide - PersonnelManagement</title>
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Personnel Data</h6>
                        <div class="d-flex align-items-center">
                            ...
                            <!-- Add Employee button -->
                            <button class="btn btn-primary mr-2" data-toggle="modal" data-target="#addEmployeeModal">Add
                                Personnel</button>
                            <!-- Edit Selected Employee button -->
                            <button class="btn btn-warning text-white mr-2" onclick="editSelectedEmployee()">Edit
                                Selected</button>
                            <!-- Delete Selected Employee button -->
                            <button class="btn btn-danger" onclick="deleteSelectedEmployees()">Delete Selected</button>
                        </div>
                    </div>
